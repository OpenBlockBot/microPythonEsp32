export default Blockly => {
    ...
    Blockly.Python.microPython_pin_setDACOutput = function (block) {
        const pin = block.getFieldValue('PIN');
        const outValue = Blockly.Python.valueToCode(block, 'OUT', Blockly.Python.ORDER_FUNCTION_CALL) || '0';
    ...
    Blockly.Python.microPython_pin_esp32ReadTouchPin = Blockly.Python.microPython_pin_readTouchPin;
