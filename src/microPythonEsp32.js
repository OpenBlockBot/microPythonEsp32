...
class OpenBlockMicroPythonEsp32Device {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new MicroPythonEsp32(this.runtime, this.DEVICE_ID);
    }
                ...
                blocks: [
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            ...
                            description: 'MicroPython esp32 set servo pin out'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
...
export default OpenBlockMicroPythonEsp32Device;
